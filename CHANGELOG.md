...
- Add support for the Responses API (`/v1/responses` endpoint) with file search capabilities for Retrieval Augmented Generation (RAG). The new `client.responses()` method enables semantic document search through OpenAI vector stores.
